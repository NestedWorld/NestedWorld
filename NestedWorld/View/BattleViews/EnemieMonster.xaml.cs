...
namespace NestedWorld.View.BattleViews
{
    ...
    {
        public static readonly DependencyProperty MonsterImageProperty = DependencyProperty.Register("MonsterImage", typeof(string), typeof(EnemieMonster), null);
        public static readonly DependencyProperty MonsterNameProperty = DependencyProperty.Register("MonsterName", typeof(string), typeof(EnemieMonster), null);
        public static readonly DependencyProperty MonsterLevelProperty = DependencyProperty.Register("MonsterLevel", typeof(string), typeof(EnemieMonster), null);
